...
O cabeçalho de proveniência é definido em `reference/pkm/pkm-url-header-format.md` e antecede sempre o corpo descrito aqui. Ele não faz parte deste template.
