...
Esta skill avalia a qualidade editorial de arquivos `url_` com `modelo: url-resumo` usando o texto-fonte cacheado como referência. Não faz pesquisa externa — trabalha exclusivamente com o arquivo e o cache existente.
...
- `.agents/skills/processar-url/SKILL.md` — contexto do ciclo de vida e cache
