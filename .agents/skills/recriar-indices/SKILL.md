...
Esta skill varre as pastas de tópicos, extrai o frontmatter de arquivos `_grupo.md` e regenera o índice JSON correspondente. **NUNCA sobrescreva índices sem aprovação explícita do usuário.**
...
Informe: *"Índice recriado com sucesso."*
...
- `reference/pkm/pkm-conventions.md` — convenção de índices JSON (seção Índices JSON)
